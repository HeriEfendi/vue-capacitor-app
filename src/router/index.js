...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'savings/create', name: 'SavingsCreate', component: () => import('../views/accounting/savings/CreateView.vue') },
      { path: 'savings/:id/edit', name: 'SavingsEdit', component: () => import('../views/accounting/savings/EditView.vue') },
