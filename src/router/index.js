...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'raw-materials', name: 'RawMaterialsList', component: () => import('../views/supply-chain/raw-materials/ListView.vue') },
      ...
      { path: 'capital', name: 'CapitalList', component: () => import('../views/accounting/capital/ListView.vue') },
      ...
      { path: 'catatan_proyek', name: 'FinancialRecords', component: () => import('../views/catatan_proyek/Index.vue') },
      { path: 'catatan_proyek/:id', name: 'FinancialRecordsDetails', component: () => import('../views/catatan_proyek/Details.vue') },
